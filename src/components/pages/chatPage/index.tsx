...
function ChatPage() {
  ...
  return (
    <PageLayout isAuthPage>
      <div className="w-full bg-slate-900 flex flex-1 flex-col justify-between rounded-2xl p-4 ">
        <div className="mt-10">
          ...
          {parsedData && (
            <div className="mt-5 p-4 bg-surface rounded-md ">
              <h4 className="font-bold text-textPrimary mb-2">
                Analysis Result:
              </h4>
              <div className="text-sm bg-slate-600 p-3 rounded-md border max-h-48 overflow-y-auto">
